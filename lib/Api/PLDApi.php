...
class PLDApi
{
    ...
    public function getPLD($x_api_key, $body)
    {
        list($response) = $this->getPLDWithHttpInfo($x_api_key, $body);
        return $response;
    }
    ...
    public function getPLDAsync($x_api_key, $body)
    {
        return $this->getPLDAsyncWithHttpInfo($x_api_key, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getPLDRequest($x_api_key, $body)
    {
